<?php
    ...
    if(isset($_POST['insert_mentor'])){
        ...
        if($number>0){
            echo "<script>alert('Mentor Name already exist')</script>";
        }else{
...
<form action="" method="post">
    <div class="input-group w-90 mb-2">
        ...
        <input type="text" class="form-control" name="Mentor_Name" placeholder="Dr S.Disanayaka" aria-label="mentor" aria-describedby="basic-addon1">
    </div>
    <div class="input-group w-10 m-auto">
        <input type="submit" class="border-0 my-3 p-2 bg-dark text-light" name="insert_mentor" value="Insert Mentor">
    </div>
</form>  