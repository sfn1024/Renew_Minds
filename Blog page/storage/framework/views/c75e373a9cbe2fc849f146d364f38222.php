...
} elseif ($_instance->childHasBeenRendered('XG0qPRK')) {
    $componentId = $_instance->getRenderedChildComponentId('XG0qPRK');
    $componentTag = $_instance->getRenderedChildComponentTagName('XG0qPRK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XG0qPRK');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('XG0qPRK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('xS4oWNq')) {
    $componentId = $_instance->getRenderedChildComponentId('xS4oWNq');
    $componentTag = $_instance->getRenderedChildComponentTagName('xS4oWNq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xS4oWNq');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('xS4oWNq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
