...
} elseif ($_instance->childHasBeenRendered('EKPHXYi')) {
    $componentId = $_instance->getRenderedChildComponentId('EKPHXYi');
    $componentTag = $_instance->getRenderedChildComponentTagName('EKPHXYi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('EKPHXYi');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('EKPHXYi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
